...
;// CONCATENATED MODULE: ./src/reduxIntegration/reducers.js
...
function reducer(state = initialState, action) {
  ...
  switch (type) {
    case actionTypes/* REQUEST_START */.N1:
    ...
    case actionTypes/* LOAD_BLOGLIST_SUCCESSFULLY */.sc:
      return _objectSpread(_objectSpread({}, state), {}, {
        blogs: payload,
        loading: false,
        error: null
    ...
    case actionTypes/* LOAD_BLOG_SUCCESSFULLY */.TI:
      return _objectSpread(_objectSpread({}, state), {}, {
        singleBlog: payload,
        loading: false,
        error: null
    ...
    case actionTypes/* LOAD_WORKLIST_SUCCESSFULLY */.a_:
      return _objectSpread(_objectSpread({}, state), {}, {
        works: payload,
        loading: false,
        error: null
    ...
    case actionTypes/* LOAD_WORK_SUCCESSFULLY */.be:
      return _objectSpread(_objectSpread({}, state), {}, {
        singleWork: payload,
        loading: false,
        error: null
    ...
    case actionTypes/* LOAD_STAFF_SUCCESSFULLY */.oA:
      return _objectSpread(_objectSpread({}, state), {}, {
        staff: payload,
        loading: false,
        error: null
    ...
    case actionTypes/* LOAD_TESTIMONIALS_SUCCESSFULLY */._u:
      return _objectSpread(_objectSpread({}, state), {}, {
    ...
    case actionTypes/* LOAD_CLIENTS_SUCCESSFULLY */.A7:
      return _objectSpread(_objectSpread({}, state), {}, {
        clients: payload,
        loading: false,
        error: null
    ...
    case actionTypes/* POST_CONTACTUS_SUCCESSFULLY */.WC:
    case actionTypes/* LOAD_BLOG_FAILURE */.sP:
    case actionTypes/* LOAD_WORK_FAILURE */.dr:
    case actionTypes/* LOAD_STAFF_FAILURE */.Mw:
    case actionTypes/* LOAD_BLOGLIST_FAILURE */.je:
    case actionTypes/* LOAD_WORKLIST_FAILURE */.s$:
    case actionTypes/* LOAD_TESTIMONIALS_FAILURE */.Dy:
    case actionTypes/* LOAD_CLIENTS_FAILURE */.dt:
      return _objectSpread(_objectSpread({}, state), {}, {
        loading: false,
        error: true
      });

    case actionTypes/* POST_CONTACTUS_FAILURE */.eA:
      return _objectSpread(_objectSpread({}, state), {}, {
        loading: false,
        error: payload,
        contactSuccess: false
...
;// CONCATENATED MODULE: ./src/reduxIntegration/store.js
...
/* harmony default export */ const reduxIntegration_store = (store);
...
function MyApp({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(external_react_redux_.Provider, {
    store: reduxIntegration_store,
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)((head_default()), {
      children: [/*#__PURE__*/jsx_runtime_.jsx("title", {
        children: "Xi Creatives - Creative Digital & Marketing Agency"
      }), /*#__PURE__*/jsx_runtime_.jsx("link", {
        rel: "icon",
        type: "image/png",
        href: "/favicon.ico"
      })]
    }), /*#__PURE__*/jsx_runtime_.jsx(cursor, {}), /*#__PURE__*/jsx_runtime_.jsx(Loading_Screen, {}), /*#__PURE__*/jsx_runtime_.jsx(Component, _app_objectSpread({}, pageProps)), /*#__PURE__*/jsx_runtime_.jsx(components_scrollToTop, {}), /*#__PURE__*/jsx_runtime_.jsx((script_default()), {
      id: "wow",
      src: "/js/wow.min.js"
...
var __webpack_exports__ = __webpack_require__.X(0, [7483], () => (__webpack_exec__(9603)));
